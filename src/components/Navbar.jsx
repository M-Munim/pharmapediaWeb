      ...
      <div className="h-10 bg-blue w-full flex items-center justify-center">
        <div className="w-9/12 flex m-auto justify-between">
          <div className="flex items-center text-white gap-3">
            <a href="#" className='text-base border-r border-borderBlue md:border-r-2 pr-3 py-1' aria-label="Facebook">
              <FaFacebookF className='cursor-pointer' />
            </a>
            <a href="#" className='text-base border-r border-borderBlue md:border-r-2 pr-3 py-1' aria-label="YouTube">
              <FaYoutube className='cursor-pointer' />
            </a>
      ...
      <div className="w-10/12 flex justify-between items-center m-auto bg-slate-100 h-28">
        ...
        <div className="flex-grow">
          <ul className='flex justify-center items-center gap-6 text-lg'>
            ...
            <li>
              <a href="#" className="hover:text-blue-500">Our Products</a>
            </li>
            <li>
