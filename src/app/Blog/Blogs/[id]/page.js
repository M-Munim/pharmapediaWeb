      ...
      <section className='h-[577px] flex justify-center items-center' style={{ backgroundImage: "url('/SubBlogMain.svg')" }}>
        <div className="w-10/12 m-auto">
          <div className="text-white mb-3">
            <h2 className="text-3xl md:text-6xl font-medium tracking-wider mb-3 mt-20 w-11/12">{params.id} Efficient Rules How to Organize Your Working Place</h2>
            <p className="text2xl md:text-4xl">Relationship tips couples therapists are giving all <br /> the time</p>
          </div>
          <div className="flex items-center justify-between w-full md:w-1/2 text-white bg-yellow-500">
            {/* <div className="flex items-center justify-center bg-purple-700 w-2/3"> */}
            <p className="text-base md:text-xl">by Joanna Wellick</p>
            ...
            {/* </div>
            <div className="flex items-center justify-center bg-pink-600 w-1/3"> */}
            <div className="w-6 border-1 border-white"></div>
        ...
        <div className="flex justify-start md:justify-between items-start mt-20">
          ...
          <div className="w-10/12 lg:w-8/12 relative z-40">
            ...
            <div className="">
              ...
              <p className="text-base md:text-lg leading-5 md:leading-8 mb-3"> Eget aenean tellus venenatis. Donec odio tempus. Felis arcu pretium metus nullam quam aenean sociis quis sem neque vici libero. Venenatis nullam fringilla pretium magnis aliquam nunc vulputate integer augue ultricies cras. Eget viverra feugiat cras ut. Sit natoque montes tempus ligula eget vitae pede rhoncus maecenas consectetuer commodo condimentum aenean.</p>
            </div>

            <div className="">
              <div className="mt-16">
                <h1 className="text-[22px] md:text-4xl font-bold leading-tight uppercase mb-3">Eu ridiculus fringilla aenean</h1>
                ...
                <ul className='ml-10 md:ml-24 my-10 md:my-14 list-disc'>
            ...
            <div className="">
              <div className="uppercase mb-5">
                <h1 className="text-[22px] md:text-4xl font-bold leading-tight uppercase">Sign Up for Our Newsletters</h1>
                <h1 className="text-[20px] md:text-[33px] font-bold leading-tight uppercase text-[#A9A9A9]">Get notified of the best deals on our WordPress themes.</h1>
              </div>

              <form className='flex flex-col md:flex-row justify-center items-center gap-7'>
                <input
                  type="text"
              ...
              <div className="flex mb-8 gap-3 items-center justify-start my-6">
                ...
                <p className="text-sm md:text-base font-medium text-[#A9A9A9]">By checking this box, you confirm that you have read and are agreeing to our terms of use regarding the storage of the data submitted through this form.
                </p>
              </div>
            </div>
          </div>
