      ...
      <section className='h-[577px] flex justify-center items-center' style={{
        ...
        <div className="w-11/12 md:w-10/12 m-auto">
          ...
          <div className="flex items-center justify-between w-full md:w-1/2 text-white">
            <p className="text-xs sm:text-base md:text-xl">by Joanna Wellick</p>
            ...
            <FaTwitter className='cursor-pointer hidden md:inline-block' />
            <FaPinterest className='cursor-pointer hidden md:inline-block' />
        ...
        <div className="flex justify-start lg:justify-between items-start mt-20">
          ...
          <div className="w-10/12 lg:w-8/12 relative z-40">
            ...
            <div className="text-justify">
              ...
              <p className="text-sm sm:text-base md:text-lg sm:leading-5 md:leading-8 mb-3"> Eget aenean tellus venenatis. Donec odio tempus. Felis arcu pretium metus nullam quam aenean sociis quis sem neque vici libero. Venenatis nullam fringilla pretium magnis aliquam nunc vulputate integer augue ultricies cras. Eget viverra feugiat cras ut. Sit natoque montes tempus ligula eget vitae pede rhoncus maecenas consectetuer commodo condimentum aenean.</p>
            </div>

            <div className="">
              <div className="mt-16">
                <h1 className="text-lg sm:text-[22px] md:text-4xl font-bold leading-tight uppercase mb-3">Eu ridiculus fringilla aenean</h1>
                <p className="text-sm sm:text-base md:text-lg sm:leading-5 md:leading-8 mb-4 ml-2 text-justify">Sociis consequat adipiscing sit curabitur donec sem luctus cras natoque vulputate dolor eget dapibus. Nec vitae eros ullamcorper laoreet dapibus mus ac ante viverra. A aenean sit augue curabitur et parturient nisi sed enim. Nulla nec quis sit quisque sem commodo ultricies neque. Lorem eget venenatis dui ante luctus ultricies tellus montes. Quis in sapien tempus.</p>

                <ul className='ml-10 md:ml-24 my-10 md:my-14 list-disc text-sm sm:text-base'>
              ...
              <div className="flex justify-center items-center">
                <div className="w-1/4 flex items-center justify-center gap-2 py-3 border-b text-xs md:text-base">
                  <p className="">694 <span className="font-semibold text-pClr"> Share</span></p>
                </div>

                <div className="w-1/4 flex items-center justify-center gap-2 py-3 border-b border-facebook text-xs md:text-base">
                  <FaFacebook className='text-facebook hidden sm:inline-block' />
                  <p className=""><span className='uppercase font-semibold' style={{
                    color: "#3B5998"
                  }} >Share </span>694</p>
                </div>

                <div className="w-1/4 flex items-center justify-center gap-2 py-3 border-b border-twitter text-xs md:text-base">
                  <FaTwitter className='text-twitter hidden sm:inline-block' />
                  <p className="">694 <span className='uppercase font-semibold text-twitter'>TWEET</span></p>
                </div>

                <div className="w-1/4 flex items-center justify-center gap-2 py-3 border-b border-pintrest text-xs md:text-base">
                  <FaPinterest className='text-pintrest' />
                  <p className="">694</p>
                </div>
              </div>
              <button className="button-filledext my-10 md:my-20 tracking-widest">VIEW COMMENTS (0)</button>
            </div>

            <div className="">
              <div className="uppercase mb-5">
                <h1 className="text-lg sm:text-[22px] md:text-4xl font-bold leading-tight uppercase">Sign Up for Our Newsletters</h1>
                <h1 className="text-base sm:text-[20px] md:text-[33px] font-bold leading-tight uppercase text-[#A9A9A9]">Get notified of the best deals on our WordPress themes.</h1>
              </div>

              <form className='flex flex-col md:flex-row justify-center items-center gap-3 md:gap-7'>
                <input
                  type="text"
                  placeholder="Enter your name"
                  required
                  className='h-10 md:h-16 w-full rounded-sm bg-transparent p-3 outline-none border-slate-200 border-1'
                />
                <input
                  type="email"
              ...
              <div className="flex mb-8 gap-3 items-center justify-start my-6">
                ...
                <p className="text-xs sm:text-sm md:text-base font-medium text-[#A9A9A9]">By checking this box, you confirm that you have read and are agreeing to our terms of use regarding the storage of the data submitted through this form.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="">
        <div className="">
          <div className="w-11/12 m-auto flex justify-center items-center flex-wrap gap-7">
            ...
            {/* <Link href={`/Blog/${blogData.slug}`} key={blogData.id}>123 */}
              ...
              <div className="relative my-5" style={{ width: "400px" }} key={blogData.id}>
                ...
                <div className="mt-8">
                  ...
                  <div className="w-11/12">
                    ...
                    <p className="my-5 text-pClr leading-5 md:leading-6 text-sm sm:text-base">{blogData.data}</p>
